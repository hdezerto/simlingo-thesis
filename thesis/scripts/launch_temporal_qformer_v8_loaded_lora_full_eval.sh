...
# Launch a full Bench2Drive evaluation for the completed Q-former v8 loaded-LoRA
# diagnostic run. Run this from an interactive tmux session, not with sbatch. The script
# starts start_eval_simlingo.py, which then submits per-route Slurm jobs.
...
export EVAL_RUN_NAME="simlingo_temporal_qformer_v8_loaded_lora_full"
export EVAL_AGENT_NAME="${EVAL_RUN_NAME}"

RUN_DIR="${REPO_DIR}/outputs/2026_05_24_17_47_08_temporal_qformer_v8_loaded_lora_8gpu"
CKPT_NAME="final"
