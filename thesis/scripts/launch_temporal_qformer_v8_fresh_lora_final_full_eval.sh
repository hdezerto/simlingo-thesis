...
# Launch a full Bench2Drive evaluation for the completed Q-former v8 fresh-LoRA
# run. Run this from an interactive tmux session, not with sbatch. The script
...
export EVAL_RUN_NAME="simlingo_temporal_qformer_v8_fresh_lora_final_full"
